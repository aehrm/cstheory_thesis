...
\begin{observation}
    Die NP-Relation $\mathtt{r4CHROMINDEX}$ ist $\leqlp$-vollständig, und die zugehörige Projektion  $\Proj(\mathtt{r4CHROMINDEX})\in\NP$ ist $\leqmp$-vollständig, und $\P$-isomorph zu $\mathtt{SAT}$.
