...
\begin{itemize}[nosep]
    ...
    \item $\neg\mathsf{KvL}$ genau dann wenn $\mathit{sat}$ effektiv $\P$-optimal ist (Satz~\ref{thm:kvl-ps}).
\end{itemize}
...
Nun gilt aber nach Annahme auch $\neg\mathsf{KvL}$. Über Satz~\ref{thm:kvl-ps}(5) gilt, dass $\mathit{sat}$ das optimale Beweissystem $h$ effektiv $\P$-simulieren kann. Wir haben also zwei Funktionen $f', g'\in\FP$ sodass
