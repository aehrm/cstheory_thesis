...
\begin{proof}
    ...
    \item Zu (1): Wir haben
        ...
        \end{gather*}
        wobei hier die existentizell quantifizierte Variable $f$ nur über Reduktionsfunktionen von $L$ auf $L$ reichen soll.
    \item Zu (2): Ähnlich wie (1), nur etwas aufwändiger. Wir haben
        ...
        \end{gather*}
        wobei wieder die existentizell quantifizierte Variable $f$ nur über Reduktionsfunktionen von $L$ auf $L$ reichen soll.
    \end{prooflist}
\end{proof}
