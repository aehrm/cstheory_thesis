...
\usepackage[bottom=4.2cm,top=2.8cm,headsep=1.5cm,foot=.8cm,inner=1.8cm,outer=5.5cm,marginparwidth=4.4cm,a4paper]{geometry}
\else
...
\titleformat{\chapter}
    ...
    {1em}
    {\setstretch{0.9}\raggedright\huge\itshape #1}
\titleformat{\section}
    {\itshape\Large}
    {\normalfont\thesection}
    {1em}
    {\setstretch{0.9}\raggedright\itshape #1}
\titleformat{\subsection}
    {\scshape}
    {\raggedright\normalfont\thesubsection}
    {1em}
    {\setstretch{0.9}\raggedright\MakeLowercase{#1}}

\contentsmargin[1cm]{.7cm}
\titlecontents{chapter}[20pt]
    {}
{\contentsmargin{0pt}\hspace{-18pt}\makebox[18pt][r]{\Large\thecontentslabel\hspace*{12pt}}\Large}
