...
\usepackage[bottom=4cm,top=3cm,foot=.8cm,inner=1.7cm,outer=4.8cm,a4paper]{geometry}
...
\setlist[enumerate]{label=(\arabic*), itemsep=0pt plus 3pt, topsep=5pt plus 4pt minus 1pt}
