...
\item (1)$\Rightarrow$(2): 
    ...
    Definiere nun die folgende NPTM $N'(w)$:\marginnote{\todo{Warum können wir nicht als Eingaben $(w, x)$ nehmen und sofort akzeptieren wenn $f(x)=w$? Dann wäre „ehrlich“ weg\ldots{}}}\\
    \begin{algorithm}[H]
