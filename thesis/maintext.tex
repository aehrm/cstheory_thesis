...
\begin{definition}[Sparsame (\emph{“parsimonious”}) Reduktionen]
    Seien $Q, R$ NP-Relationen. Wir sagen dass sich $Q$ auf $R$ (in Polynomialzeit) \emph{sparsam} (\emph{„parsimonious“}\sidenote{vgl. Rothe.}) reduzieren lässt, bzw. $Q\leq_\mathrm{pars}^\mathrm p R$ wenn eine Funktion $f\in\FP$ existiert mit
...
\begin{definition}[Strukturerhaltende Reduktion; Lynch, Lipton, 1878]
...
\begin{definition}[Zertifikats-Isomorphie; Fischer, Hemaspaandra, Torenvliet, 1995]
    Seien $Q, R$ NP-Relationen. Wir sagen dass sich $Q$ auf $R$ (in Polynomialzeit) \emph{zertifikats-isomorph reduzieren lässt}, bzw. $Q\leq_\mathrm{wi}^\mathrm p R$, wenn zwei Funktionen $f, g\in \FP$ existieren, die p-invertierbar (also auch injektiv\marginnote{das steht so direkt aber nicht bei FHT}) sind, und 
    \begin{enumerate}
    ...
    \end{enumerate}
    Definiere $Q\leq_\mathrm{wi}^\mathrm p$-Vollständigkeit entsprechend.\marginnote{Brauchen wir die wi-Isomorphie?}
