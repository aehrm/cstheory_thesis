...
\begin{figure*}
    ...
    \vspace*{-2cm}
\caption{1.~nach \textcite[Thm.~5]{rackoff_relativized_1982}. 
...
Abbildung~\ref{fig:oracles} zeigt, welche der Hypothesen unter relativierbaren Beweisen durch ein Orakel voneinander getrennt sind. 
