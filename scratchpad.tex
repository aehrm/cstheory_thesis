...
Definiere folgende Zeugensprachen:
        ...
        \end{gather*}
        Fakt: $|O\cap \Sigma^n|\leq 1$ für alle $n\in H_m \implies (A_m^O, B_m^O)\in\DisjNP$.
...
\begin{enumerate}[label={V\arabic*}]
    ...
    \item Wenn $0<t(\tau^1_{a,b})=m$, dann gilt für alle $n\in H_m$ dass $|\Sigma^n\cap w|\leq 1$.\\
        (Wenn $0<t(\tau^1_{a,b})=m$, dann $(A_m,B_m)\in\DisjNP$.)
...
\begin{claim}
    Kein Paar aus $\DisjNP^O$ ist $\leqmpp$-vollständig.
\end{claim}
